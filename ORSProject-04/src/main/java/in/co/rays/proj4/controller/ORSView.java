...
public interface ORSView {
	...
	public String TAX_VIEW = PAGE_FOLDER + "/TaxView.jsp";
	public String  TAX_CTL = APP_CONTEXT + "/ctl/TaxCtl";

	public String TAX_LIST_VIEW = PAGE_FOLDER + "/TaxListView.jsp";
	public String  TAX_LIST_CTL = APP_CONTEXT + "/ctl/TaxListCtl";
	
	
	public String COUNTRY_VIEW = PAGE_FOLDER + "/CountryView.jsp";
	public String  COUNTRY_CTL = APP_CONTEXT + "/ctl/CountryCtl";

	public String  COUNTRY_LIST_VIEW = PAGE_FOLDER + "/CountryListView.jsp";
	public String  COUNTRY_LIST_CTL = APP_CONTEXT + "/ctl/CountryListCtl";
}
